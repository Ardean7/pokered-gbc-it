...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_EU_STAFF, CRED_EU_STAFF_2, CRED_TEXT_FADE
	db CRED_EU_COORD, CRED_EU_COORD_2, CRED_MOYSE, CRED_TEXT_FADE
