...
; entries correspond to TRADE_FOR_* constants
	...
	db ABRA,       MR_MIME,   TRADE_DIALOGSET_CASUAL,    "MARCELLO@@@"
	db BUTTERFREE, BEEDRILL,  TRADE_DIALOGSET_HAPPY,     "CHIKUCHIKU@" ; unused
	db PONYTA,     SEEL,      TRADE_DIALOGSET_CASUAL,    "MARINAIO@@@"
	db SPEAROW,    FARFETCHD, TRADE_DIALOGSET_HAPPY,     "DUCCIO@@@@@"
	...
	db VENONAT,    TANGELA,   TRADE_DIALOGSET_HAPPY,     "GRINZA@@@@@"
